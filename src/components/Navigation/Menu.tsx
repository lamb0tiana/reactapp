                    ...
                    <div className="nav-collapse">
                        ...
                        <ul className="nav pull-right">
                            <li className="dropdown">
                                <a data-toggle="dropdown" className="dropdown-toggle" href="#"><span
                                    className="icon-lock"></span> Login <b className="caret"></b></a>
                                <div className="dropdown-menu">
                                    <form className="form-horizontal loginFrm">
                                        ...
                                        <div className="control-group">
                                            <input type="password" className="span2" id="inputPassword"
